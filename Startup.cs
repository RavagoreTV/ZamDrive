...
namespace ZamkDb
{
	public class Startup
	{
		...
		public void ConfigureServices(IServiceCollection services)
		{
			...
			services.AddDbContext<ZamDbContext>(options =>
			...
			services.AddTransient<IParticipantService, EFParticipantService>();

			services.AddIdentity<IdentityUser, IdentityRole>().AddEntityFrameworkStores<ZamDbContext>();
		}
